            ...
            <div className="user-auth__wrapper">
                ...
                <form className="user-auth__form">
                    <label className="user-auth__name-input">
                        E-mail
                        <input type="email" required={true} placeholder='Введите E-mail' className="user-auth__input user-auth__input_bold" />
                        <span className="validation-error"></span>
                    </label>
                    <label className="user-auth__name-input">
                        Пароль
                        <input type="password" required={true}  placeholder='Введите пароль' className="user-auth__input" />
